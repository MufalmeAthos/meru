(function() {
    ...
    $("html").niceScroll({styler:"fb",cursorcolor:"#d40000", cursorwidth: '12', cursorborderradius: '10px', background: '#f1f1f1', spacebarenabled:false, cursorborder: '0',  zindex: '1000'});
