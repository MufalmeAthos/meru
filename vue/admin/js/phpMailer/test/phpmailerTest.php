...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testMultiplePlainFileAttachment()
    {
        ...
        if (!$this->Mail->addAttachment('../examples/donnees/phpmailer.png')) {
...
EOT;
        $this->Mail->addEmbeddedImage(
            '../examples/donnees/phpmailer.png',
            'my-attach',
            'phpmailer.png',
            'base64',
            'image/png'
...
EOT;
    ...
    public function testHTMLAttachment()
    {
        ...
        if (!$this->Mail->addAttachment('../examples/donnees/phpmailer_mini.png', 'phpmailer_mini.png')) {
            $this->assertTrue(false, $this->Mail->ErrorInfo);
            return;
        }
    ...
    public function testHTMLMultiAttachment()
    {
        ...
        if (!$this->Mail->addAttachment('../examples/donnees/phpmailer.png', 'phpmailer.png')) {
            $this->assertTrue(false, $this->Mail->ErrorInfo);
            return;
        }
