...
try {
    if (isset($_POST["submit"]) && $_POST['submit'] == "Submit") {
        ...
        $mail->addAttachment('donnees/phpmailer_mini.png', 'phpmailer_mini.png'); // optional name
        $mail->addAttachment('donnees/phpmailer.png', 'phpmailer.png'); // optional name
        $example_code .= "\n\$mail->addAttachment('donnees/phpmailer_mini.png'," .
