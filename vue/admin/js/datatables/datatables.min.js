...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Start",sLast:"End",sNext:"Next",sPrevious:"Preview"},sEmptyTable:"No data in the table",sInfo:"Display _START_ to _END_ over _TOTAL_ data",sInfoEmpty:"Display 0 to 0 over 0 data",sInfoFiltered:"(filter of _MAX_ total data)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Display _MENU_ data",sLoadingRecords:"Charging...",sProcessing:"waiting...",sSearch:"Research:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No corresponding data found"},
