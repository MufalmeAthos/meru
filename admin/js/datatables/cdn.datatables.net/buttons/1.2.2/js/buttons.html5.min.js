...
"Copier sur le clipboard"),b.i18n("buttons.copySuccess",{1:"Une ligne copié sur le clipboard",_:"%d lignes copiées sur le clipboard"},a.rows),2E3);return}}catch(h){}}e=g("<span>"+b.i18n("buttons.copyKeys","Appuyer <i>ctrl</i> ou <i>⌘</i> + <i>C</i> pour copier la table <br>sur le clipboard de votre système.<br><br>Pour annuler, cliquer sur ce messahe ou appuyer sur ESC.")+"</span>").append(d);b.buttons.info(b.i18n("buttons.copyTitle","Copier to clipboard"),e,0);c[0].focus();c[0].select();var l=g(e).closest(".dt-button-info"),i=function(){l.off("click.buttons-copy");
